...
class Driver(Person):
    ...
    def __init__(self, name, age, driver_id, Gender, Department):
...
driver1 = Driver("Vivek kumar",28,"CNU12345", "Male", "BUS")
driver2 = Driver("Sameera prakash",27,"CNU67890", "Female", "BUS")
